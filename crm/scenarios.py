...
PARCEL_LOCATION = {
    ...
    'subject_template': 'Уточнение посылки · {driver_name}',
    'steps': [
        # Пять полей §2.3, в порядке ТЗ. Первые три — из диспетчерской, они же
        # уезжают в подпись к карточке, чтобы их можно было скопировать.
...
#
# У тематик регионов сюда же уходят ФИО, номер ВУ и телефон: специалист в группе
# копирует их так же, как ИИН у Sapar, — с картинки этого не сделать.
BODY_DATA = ('iin', 'driver_name', 'driver_licence', 'contact_number',
             'park', 'city', 'office_city', 'office', 'period')
BODY_DATA_LABELS = {
    'iin': 'ИИН',
