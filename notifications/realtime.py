...
состоянии. Редкая потеря тычка и переходы чисто по времени (наступил дедлайн,
открылось окно теста) покрываются периодической сверкой живого SSE-потока.
...
# Не основной polling, а страховочная полная сверка. Она нужна источникам,
# состояние которых меняется от хода часов без UPDATE в БД (starts_at/due_at),
# и ограничивает окно устаревания при сетевом сбое LISTEN.
