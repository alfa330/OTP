...
# Разделитель двуязычной рассылки. Ровно так — десять «─» между частями —
# выглядят живые рассылки в кабинете: сначала казахская, потом русская. Формат
# не придуман нами, а повторён; тот же символ разбирает фронт при «Повторить»
