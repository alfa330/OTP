...
ПОЧЕМУ ПОДКЛАСС, А НЕ СВОЙ HTTP. Кабинет тот же, что у «Провайдера ЭДО», и
вход в него тот же — куки живого логина (у рассылок свой аккаунт, но способ
один). Значит и обращаться к кабинету надо тем же способом — с тем же набором
