...
2. ЗНАК ЗАНИМАЕТ 85 % ПЛИТКИ. Иконка объявлена maskable: Android обрезает её
   ...
   40 % стороны. Считаем: сам знак круглый и занимает 77 % СВОЕГО холста,
   значит при доле 85 % его диаметр — 0.85 × 0.77 = 65 % стороны, а радиус
   32.7 %. До границы неприкосновенного круга остаётся 7 % стороны, обрезка
   знаку не грозит. Та же картинка честно работает и как maskable, и как
   обычная, поэтому файлов три, а не шесть.
   Доля росла трижды по просьбе владельца: 56 % → 68 % → 78 % → 85 %. Считать
   её «на глаз» не надо: предел — там, где радиус знака доходит до 40 % стороны,
   то есть доля около 1.04. Раньше в этом комментарии стояло, что предел ближе
   (88 %); это была ошибка в арифметике, а не свойство Android.
...
MARK_SCALE = 0.85                 # доля плитки под знак (см. пункт 2 в шапке)
