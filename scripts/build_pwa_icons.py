...
2. ЗНАК ЗАНИМАЕТ 78 % ПЛИТКИ. Иконка объявлена maskable: Android обрезает её
   ...
   78 % его радиус — 30 % стороны, и до границы неприкосновенного круга ещё
   четверть его толщины. Та же картинка честно работает и как maskable, и как
   обычная, поэтому файлов три, а не шесть.
   Доля росла дважды по просьбе владельца: 56 % → 68 % → 78 %. Рост ограничен
   не вкусом, а той самой границей: при 88 % знак пошёл бы под обрезку на
   круглых темах Android, и на домашнем экране у него срезало бы края.
...
MARK_SCALE = 0.78                 # доля плитки под знак (см. пункт 2 в шапке)
