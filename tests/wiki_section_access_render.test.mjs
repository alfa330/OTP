...
test('кнопка ведёт на выдачу, а не на одно правило', () => {
  /* 16.09.2026 экран правила стал экраном выдачи: адресатов отмечают галочками
     и выдают права всем одним сохранением. Подпись кнопки — единственное
     обещание на экране списка, и «Добавить правило» обещало бы по-прежнему
     одного адресата за раз. */
  assert.match(render(), /Выдать доступ/);
});
