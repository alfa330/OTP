...
# Чем тематика «Уточнение посылки» отправляется: пять полей §2.3 ТЗ #201 и
# город — его добавили по возврату постановщика 27.08.2026, и без него сервер
# обращение не принимает.
PARCEL_ANSWERS = {
