...
INCOMING = {
    ...
    "fromUser": {"id": "77000000112", "name": "«А»«И»«К»", "phone": "77000000112"},
}
BITRIX_GREETING = {
...
SYSTEM_ASSIGN = {
    ...
    "message": {"text": 'Назначен ответственный "Тестова Аяжан [85501]"', "file": None},
...
class MessageRowTests(unittest.TestCase):
    def test_row_keeps_employee_even_for_autoreply(self):
        ...
        row = chatapp_client.message_row(BITRIX_GREETING, 72861, 'caWhatsApp', '77000000112')
    ...
    def test_chat_row_reads_responsible(self):
        row = chatapp_client.chat_row({
            'id': '77000000112', 'internalId': '77904461', 'licenseId': 72861,
            'messengerType': 'caWhatsApp', 'type': 'private', 'phone': '77000000112',
...
class SnapshotMessageTests(unittest.TestCase):
    ...
    def _row(self, **over):
        base = {
            ...
            'human_out': True, 'is_bot': False, 'matched_name': 'Тестова Аяжан Тесткызы',
            'author_name': 'Тестова Аяжан',
        }
        base.update(over)
        return base
    ...
    def test_operator_reply_is_to_client_with_matched_name(self):
        ...
        self.assertEqual(out['author'], 'Тестова Аяжан Тесткызы')
