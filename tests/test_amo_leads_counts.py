...
Фикстура — снимок вкладки «Импорт ДЕНЬ» за 05.08.2026 (1654 сделки), из
которого оставлены ТОЛЬКО две колонки, по которым считает count_by_source:
tags и utm_source. Персональные данные (телефоны клиентов, ФИО ответственных,
id сделок) вырезаны и не должны возвращаться в фикстуру ни при каком обновлении.
Эталон — цифры, которые в тот день показывала сама таблица. Тест держит перенос честным:
