...
SPACE_FEATURES = (
    ...
    # Вкладка «Новости». Сами новости пространству НЕ принадлежат: их адресуют
    # отделом, направлением, группой и должностью, а окно показывается вне вики
    # вовсе. Тумблер отвечает ровно на один вопрос — «есть ли эта дверь в
    # ЭТОМ пространстве»: у клиентской вики (Тез КЦ) объявления по нашей
    # оргструктуре не нужны, как не нужен там и «Помощник».
