...
3. НАЗВАНИЕ В ВОПРОСЕ МОЖЕТ ОТЛИЧАТЬСЯ ОТ НАЗВАНИЯ В СТАТЬЕ. «Жетіқазына»,
   ...
   словом или цифрой, казахское написание или русское. Если во фрагментах есть
   явно та же вещь под другим написанием — отвечай про неё, назвав написание из
   статьи. Не отказывай из-за расхождения в написании.
