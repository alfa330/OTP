...
Из него следует всё остальное:
  ...
  * таблицы и картинки СТАТЬИ вырезаются маркерами ровно так же, как таблицы
    ...
    Модель их не переписывает — она расставляет маркеры;
...
1. Маркеры [[ТАБЛИЦА-N]] и [[КАРТИНКА-N]] переноси ДОСЛОВНО, каждый отдельным
   абзацем. Не пересказывай содержимое таблицы словами и не меняй номер. Если
   таблица устарела и в документе есть её новая версия — поставь маркер новой
   вместо старой. Лишние маркеры не выдумывай.
