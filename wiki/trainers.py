...
# урок человека.
#
# 'phone' — вкладка «Тренажёры» в iCORE Phone (страница trainers.html внутри
# WebView2 телефона, 25.09.2026). Отдельный источник, а не 'catalog': статистике
# важно видеть, что операторы проходят тренажёры прямо на смене из телефона.
SOURCES = ('article', 'catalog', 'phone')
