...
ROLE_TITLES = {
    ...
    'operator': 'Оператор',
    'trainee': 'Стажёр',
    # Должности отделов без линии. Вика открыта им тумблером отдела, значит и в
    # выгрузке прохождений они появляются — без подписи в колонке «Должность»
    # стоял бы сырой код роли.
