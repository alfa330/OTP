...
def _normalize_for_index(value):
    ...
    normalized = str(value or '').lower().replace('ё', 'e')
...
def normalize_text(text):
    """Регистр, ё -> e, мусорные символы -> пробел, схлопывание пробелов.

    Обратите внимание: ё заменяется на ЛАТИНСКУЮ e — так в оригинале, и от
    этого зависит совпадение написаний «хёндай»/«хендай» после транслитерации.
    """
