...
Своего поля под логин Oktell здесь нет. С 21.09.2026 логин ведёт карточка СЗоВ
в «Настройках SIP» (`oktell_user_accounts.cabinet_login`), а `users.sip_number`
остался запасным для тех, кому кабинет не завели. Агент присылает логин из
cookie `__oktelllogin`, сервер ищет его только среди сотрудников СЗоВ —
правило одно, `queries.OKTELL_LOGIN_SQL`.
"""
