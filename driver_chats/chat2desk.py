...
def normalize_phone(raw):
    ...
    Две поправки на привычный ввод остаются, обе безопасны:
    «8 707 …» -> «7 707 …» (внутренняя форма Казахстана и России) и «707 …» ->
    «7 707 …» (казахстанский абонентский номер без кода страны).
