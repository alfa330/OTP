...
ложится так:
    ...
    тренер этих отделов                то же, что оператор, но без QR (с 25.09.2026, #360)
...
# Исключений по роли нет. До 25.09.2026 им был тренер («ИИН живых водителей не
# его дело»); снято по задаче #360 вместе с «Обращениями», «Посылками» и «Чатами
# водителей». Тренер проходит своим отделом, журнал ему не показывается — он не
# глава и не админ (journal_scope).
