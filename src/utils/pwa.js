...
/* Отложенное предложение: «Позже» прячет экран на две недели, а не навсегда.
   Навсегда — это молчаливая потеря: человек нажал «Позже» в метро, а спросить
   второй раз уже некому. Две недели — примерно полтора рабочих цикла. */
export const INSTALL_SNOOZE_KEY = 'otp.install_offer_v1';
