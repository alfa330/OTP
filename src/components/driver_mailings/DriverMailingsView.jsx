            ...
            <div className={`${iosCard} mt-5 overflow-hidden`}>
                ...
                {linkOpen && (
                    <div className="space-y-2 border-t border-slate-100 px-4 py-3 text-[12.5px] text-slate-600">
                        ...
                        {/* Чей аккаунт в работе — важно: от его имени рассылка
                            уйдёт, и от него зависит, в каких диспетчерских она
                            вообще разрешена. */}
                        <p className="text-[11.5px] text-slate-500">
                            {session.source === 'own'
                                ? 'Отдельный аккаунт для рассылок. Если связь прервётся, её восстанавливает разработчик со своего компьютера.'
                                : 'Сейчас используется общая связь раздела «Провайдер ЭДО». Отдельный аккаунт для рассылок подключает разработчик со своего компьютера.'}
                        </p>
