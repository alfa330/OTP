  ...
  return (
    <div className="mb-6 rounded-xl border border-teal-200 bg-teal-50/60 px-4 py-4">
      ...
      <p className="mt-2 text-xs text-teal-700">
        Индивидуальный план: по ставке (план × ставка); при переработке — пропорционально факт-часам (план ÷ норма FTE × факт);
        новичок в месяце приёма — ×0,8, при неполном месяце — пропорционально рабочим дням с даты приёма;
        при увольнении/выходе на БС — пропорционально пересчитанной норме.
        Рабочие дни и норма FTE месяца — по формуле: округл(дни месяца ÷ 7 × 5) × 8 ч.
        Подробный расчёт каждого оператора — в колонке «План успешек» (наведите на значение).
      </p>
    </div>
  );
};
