...
| Канал и кампания | `channels[]`, `campaigns[]` | один фильтр; кампания — второй уровень в том же селекторе (`ch:`/`cp:`) |
...
пустые, если сделки нет. На очереди ревью кнопки нет: там другой список.
