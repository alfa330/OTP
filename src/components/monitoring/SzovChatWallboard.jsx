 ...
 *     сколько РАЗНЫХ чатников держало линию в этот час (правая ось, люди — целые головы).
 *
...
/*
 * Людей на линии считаем головами: сколько разных чатников стояло на линии внутри часа. Число
 * целое — «1,6 человека» на стене не читается, там нужен ответ «сколько людей было» (решение
 * владельца 18.08.2026). Ноль не подписываем: пустой час и так пустой, цифра только шумит.
 */
