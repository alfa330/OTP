 ...
 *
 * Заливка — currentColor: цвет знака задаёт родитель своим цветом текста. На
 * экране входа это text-indigo-600 (#4F46E5) — ровно тот синий, что был у
 * прежней картинки.
 *
 * СПЛОШНОЙ ЦВЕТ, А НЕ ГРАДИЕНТ. Перелив «синий → фиолетовый» с favicon здесь
 * пробовали — владелец вернул сплошной синий: рядом с синей плашкой «iCORE»
 * знак уходил в фиолетовый, и половинки логотипа переставали читаться как одно
 * целое. Градиент остаётся там, где он и уместен — на плитке иконки для
 * домашнего экрана (scripts/build_pwa_icons.py), у неё свой фон.
 */
const IcoreMark = ({ className = '', title }) => (
    <svg
