    ...
    return (
        <div className="space-y-6">
            ...
            <Group
                ...
                help="Пользуются ли викой: сколько читают, кто читает и что лежит нетронутым."
            >
                <Tiles>
                    <Metric
            ...
            >
                <Tiles>
                    ...
                    <Metric
                        ...
                        helpAlign="right"
                        help={`Ответы, в которых помощник прямо сказал, что ответа в вике нет.${da.clarify ? ` Ещё ${num(da.clarify)} раз он попросил уточнить вопрос` : ' Когда он просит уточнить вопрос'} — такие обращения в дыры базы знаний не записываются.`}
                    />
                </Tiles>
