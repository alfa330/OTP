 ...
 *
 * /structure отдаёт архивные разделы и пространства тем, у кого есть право
 * управлять структурой, а с 07.09.2026 архивные РАЗДЕЛЫ своей ветки приезжают
 * ещё и держателю ветки — он убирает их туда сам, значит должен и возвращать.
 * Так и задумано: вкладке «Структура» они нужны, и она честно рисует их с
 * бейджем «В архиве». Но по этому же ответу строятся все остальные списки —
 * дерево статей, выбор раздела статьи, раздела для правила доступа,
 * родительского раздела, — а фильтра по статусу в них не было.
 *
