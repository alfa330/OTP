 ...
 *   hold   — как держать телефон. Пять кузовных кадров снимают ГОРИЗОНТАЛЬНО,
 *            салон — вертикально; в тренажёре по этому полю поворачивается сам
 *            телефон в руках, поэтому силуэт ложится вдоль машины, а ряд кнопок
 *            уезжает на бок — как в руках у водителя;
