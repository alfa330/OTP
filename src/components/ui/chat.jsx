...
export const ChatComposer = ({
    ...
    /* Просьба извне встать в поле: текст вопроса уже подставили, человеку
       ...
       disabled в зависимостях не для порядка: выключенное поле сфокусировать
       НЕЛЬЗЯ, а в момент просьбы оно чаще всего именно выключено — чат
       монтируется раньше, чем приезжает статус помощника. Без повторного
       захода курсор так и не вставал: проверкой на проде это и поймано. */
    useEffect(() => {
