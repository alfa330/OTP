...
const WORKPLACE_CABINETS = [
    ...
    },
    {
        ...
        blocks: [
            ...
            { left: 225, top: 300, rows: [[94, 93, 92, 91, 90, 89, 88]] },
        ],
        // Угловые (повёрнутые) РМ слева-внизу по диагонали: 98 (сверху) → 95 (у ряда, рядом с 94)
        freeSeats: [
            { n: 98, left: 44, top: 246, rotate: -33 },
            { n: 97, left: 92, top: 279, rotate: -33 },
            { n: 96, left: 140, top: 312, rotate: -33 },
            { n: 95, left: 190, top: 345, rotate: -33 },
        ],
    },
    {
        id: 'op2',
